...
if __name__ == '__main__':
    ...
    def voice_conversion():
        ...
        with no_grad():
            ...
            audio = net_g_ms.voice_conversion(spec.to(device), spec_lengths, sid_src=sid_src.to(device), sid_tgt=sid_tgt.to(device))[
                ...
                if choice == 't':
                    ...
                    with no_grad():
                        ...
                        audio = net_g_ms.infer(x_tst, x_tst_lengths, sid=sid, noise_scale=noise_scale,
                                               noise_scale_w=noise_scale_w, length_scale=length_scale)[0][0, 0].data.to(device).float().cpu().numpy()
                ...
                if choice == 't':
                    ...
                    with no_grad():
                        ...
                        audio = net_g_ms.infer(x_tst, x_tst_lengths, sid=sid, noise_scale=noise_scale, noise_scale_w=noise_scale_w,
                                               length_scale=length_scale, emotion_embedding=emotion)[0][0, 0].data.to(device).float().cpu().numpy()
